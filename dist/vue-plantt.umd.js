(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["vue-plantt"] = factory(require("vue"));
	else
		root["vue-plantt"] = factory(root["Vue"]);
...
//# sourceMappingURL=data:application/json;base64,
...
var enable_check = __webpack_require__("9f29");
...
// EXTERNAL MODULE: ./src/Plantt.scss
var src_Plantt = __webpack_require__("86ad");
...
// CONCATENATED MODULE: ./src/utils/enumerate.ts
...
var enumerate_enumerateMonths = function enumerateMonths(daysRange) {
  var enumMonths = [];
  var daysInMonth = 0;
  var prevMonth = '';
  var numberOfMonth = -1;

  from_default()(daysRange.by('day')).forEach(function (day) {
    daysInMonth += 1;
...
var enumerate_enumerateDays = function enumerateDays(daysRange) {
  var enumDays = [];
  var dayGridColumn = 0;
  ...
  from_default()(daysRange.by('day')).forEach(function (day) {
    enumDays.push({
      ...
      nbEvents: 0,
      isToday: day.isSame(moment_default()(), 'day'),
...
var enumerate_enumerateHours = function enumerateHours() {
  var hourStart = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 8;
  var hourEnd = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 18;

  var hours = _toConsumableArray(Array(hourEnd - hourStart + 1));

  return hours.map(function (_, index) {
    var currentHour = hourStart + index;
    return {
      num: currentHour,
...
// CONCATENATED MODULE: ./src/Plantt.tsx
...
var Moment = Object(moment_range["extendMoment"])(moment);

var Plantt_Plantt =
/*#__PURE__*/
function (_tsx$Component) {
  _inherits(Plantt, _tsx$Component);

  function Plantt() {
    var _this;

    _classCallCheck(this, Plantt);
    ...
    _this.linesFill = lines.map(function (_) {
      return from_default()(daysRange.by('day')).map(function () {
        return false;
      });
    });
    var months = enumerate_enumerateMonths(daysRange);
    var days = enumerate_enumerateDays(daysRange);
    var hours = enumerate_enumerateHours();
    var dayCellsWidth = _this.gridWidth / days.length;
    var hourCellsWidth = dayCellsWidth / hours.length;
    _this.grid = {
      months: months,
      days: days,
      hours: hours,
      dayCellsWidth: dayCellsWidth,
      hourCellsWidth: hourCellsWidth,
      height: 0
    };
    return _this;
  }
  ...
  _createClass(Plantt, [{
    ...
    value: function renderGrid() {
      ...
      var _this$grid = this.grid,
          months = _this$grid.months,
          days = _this$grid.days;
      return h("table", {
        "class": "Plantt__grid"
      }, [h("thead", [h("tr", [months.map(function (month) {
        return h("th", {
          "key": month.num,
          "attrs": {
      ...
      })]), h("tr", [days.map(this.renderGridDay)])])]);
    }
  }, {
    key: "renderGridDay",
    value: function renderGridDay(day) {
      var h = this.$createElement;
      var dayClasses = classnames_default()('Plantt__daysLine__day', {
      ...
      var _this$grid2 = this.grid,
          height = _this$grid2.height,
          dayCellsWidth = _this$grid2.dayCellsWidth;
      var minCellWidthForHours = this.minCellWidthForHours,
          useHours = this.useHours;
      return h("th", {
        "key": day.num,
        "attrs": {
          "title": day.title
        ...
        "class": "Plantt__labels",
        "style": {
          height: "".concat(height, "px")
        }
      }, [h("div", {
        "class": "Plantt__labels__top"
      }, [dayCellsWidth >= this.minCellWidthForDays && day.num, useHours && dayCellsWidth >= minCellWidthForHours && this.renderGridHours(day)]), h("div", {
        "class": "Plantt__labels__bottom"
      }, [day.nbEvents > 0 && dayCellsWidth < 100 && h("div", [day.nbEvents]), day.nbEvents > 0 && dayCellsWidth >= 100 && h("div", ["".concat(day.nbEvents, " items")]), dayCellsWidth < minCellWidthForHours && dayCellsWidth > 50 && h("div", [day.labelShort]), dayCellsWidth >= minCellWidthForHours && h("div", [day.labelLong])])])]);
    }
  }, {
    key: "renderGridHours",
    value: function renderGridHours(day) {
      var h = this.$createElement;
      var _this$grid3 = this.grid,
          height = _this$grid3.height,
          hours = _this$grid3.hours;
      return h("table", {
        "class": "Plantt__hoursLine"
      }, [h("thead", [h("tr", {
        "style": {
          height: height - 40
        }
        ...
        return h("th", {
          "key": hour.num,
          "attrs": {
            "title": "".concat(day.title, ", ").concat(hour.title, ":00")
          },
    ...
    key: "renderEvent",
    value: function renderEvent(_renderEvent) {
      var h = this.$createElement;
      ...
      var id = _renderEvent.id,
          title = _renderEvent.title,
          name = _renderEvent.name,
          locked = _renderEvent.locked,
          locScale = _renderEvent.locScale,
          extraClasses = _renderEvent.extraClasses;
      var eventClasses = classnames_default()('Plantt__event', extraClasses);
      var labelClasses = classnames_default()('Plantt__event-label', {
        'Plantt__event-label--movable': !locked
      });
      return h("div", {
        "key": "plantt-event-".concat(id),
        "attrs": {
          "event-id": id,
          "title": title
        },
    ...
    key: "getRenderEvent",
    value: function getRenderEvent(event) {
      var _this2 = this;
      ...
      var format = this.useHours ? 'LLL' : 'LL';
      var startTitle = startDate.format(format);
      var endTitle = endDate.format(format);
      ...
      if (this.useHours) {
        var eventStartHour = startDate.hour();
        var eventEndHour = endDate.hour();
        var offsetHours = Math.floor(this.grid.hourCellsWidth * (eventStartHour - this.dayStartHour));
        ...
        if (startDate.isSame(endDate, 'day')) {
          ...
          if (endDate.isAfter(this.viewEnd, 'day')) {
            ...
            eventWidth -= offsetHours + this.grid.hourCellsWidth * (this.dayEndHour + 1 - eventEndHour);
          }
        }
      }

      var eventDays = _toConsumableArray(Array(Math.round(eventLength)));

      var days = this.grid.days;
      var line = 0;
      eventDays.forEach(function (_, index) {
        var thisDay = Moment(startDate).add(index, 'days');
        var eventDay = days.find(function (currentDay) {
          return Moment(currentDay.date).isSame(thisDay, 'day');
        });
        ...
        _this2.linesFill.forEach(function (thisLine, numLine) {
          var isEmptyLine = thisLine[eventDay.offset] === false;
          ...
          _this2.linesFill[line][eventDay.offset] = "".concat(eventDay.num, ": ").concat(name);
          dayFilled = true;
        });
      });
      var width = eventWidth - daysExceed * this.grid.dayCellsWidth;
      var top = line * (this.eventHeight + this.eventMargin) + this.eventMargin;
      var locScale = {
        left: "".concat(offsetLeft, "px"),
        width: "".concat(width, "px"),
        top: "".concat(top, "px"),
        height: "".concat(this.eventHeight, "px")
      };
    ...
    value: function render() {
      ...
      return h("div", {
        "class": "Plantt"
      }, [this.renderGrid(), h("div", {
        "class": "Plantt__events-container"
      }, [this.events.map(function (event) {
        var renderEvent = _this3.getRenderEvent(event);

        return _this3.renderEvent(renderEvent);
      })])]);
    }
  }]);
...
__decorate([Prop({
  default: 6
})], Plantt_Plantt.prototype, "linesCount", void 0);

__decorate([Prop({
  default: false
})], Plantt_Plantt.prototype, "useHours", void 0);

__decorate([Prop({
  default: 8
})], Plantt_Plantt.prototype, "dayStartHour", void 0);

__decorate([Prop({
  default: 18
})], Plantt_Plantt.prototype, "dayEndHour", void 0);

__decorate([Prop({
  default: 20
})], Plantt_Plantt.prototype, "minCellWidthForDays", void 0);

__decorate([Prop({
  default: 150
})], Plantt_Plantt.prototype, "minCellWidthForHours", void 0);

__decorate([Prop({
  default: 40
})], Plantt_Plantt.prototype, "eventHeight", void 0);

__decorate([Prop({
  default: 5
})], Plantt_Plantt.prototype, "eventMargin", void 0);

__decorate([Prop({
  default: true
})], Plantt_Plantt.prototype, "useLock", void 0);

__decorate([Prop({
  default: true
})], Plantt_Plantt.prototype, "autoLock", void 0);

__decorate([Prop({
  default: 2
})], Plantt_Plantt.prototype, "lockMarginDays", void 0);

Plantt_Plantt = __decorate([vue_class_component_common_default.a], Plantt_Plantt);
/* harmony default export */ var src_Plantt_0 = (Plantt_Plantt); // VUE JSX HOT LOADER //

if (false) {}
// CONCATENATED MODULE: ./node_modules/@vue/cli-service/lib/commands/build/entry-lib.js


/* harmony default export */ var entry_lib = __webpack_exports__["default"] = (src_Plantt_0);
...
//# sourceMappingURL=vue-plantt.umd.js.map